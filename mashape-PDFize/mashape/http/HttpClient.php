...
require_once(dirname(__FILE__) . "/TokenUtil.php");

class HttpClient {

	public static function doRequest($httpMethod, $url, $parameters, $developerKey) {
		...
		if (!empty($developerKey)) {
			$token = TokenUtil::requestToken($developerKey);
		}
